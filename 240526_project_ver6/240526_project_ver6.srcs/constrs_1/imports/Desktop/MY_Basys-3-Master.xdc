...
#set_property -dict { PACKAGE_PIN W16  IOSTANDARD LVCMOS33 } [get_ports { sw[0]  }]; #IO_L20P_T3_A08_D24_14      ,Sch=SW2
#set_property -dict { PACKAGE_PIN W17  IOSTANDARD LVCMOS33 } [get_ports { sw[1]  }]; #IO_L20N_T3_A07_D23_14      ,Sch=SW3
