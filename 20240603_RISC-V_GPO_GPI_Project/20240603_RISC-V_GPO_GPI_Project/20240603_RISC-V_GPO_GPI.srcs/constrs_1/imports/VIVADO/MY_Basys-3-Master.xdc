...
#set_property -dict { PACKAGE_PIN W16  IOSTANDARD LVCMOS33 } [get_ports { IOPortB[0]  }]; #IO_L20P_T3_A08_D24_14      ,Sch=SW2
#set_property -dict { PACKAGE_PIN W17  IOSTANDARD LVCMOS33 } [get_ports { IOPortB[1]  }]; #IO_L20N_T3_A07_D23_14      ,Sch=SW3
...
#set_property -dict { PACKAGE_PIN U16  IOSTANDARD LVCMOS33 } [get_ports { IOPortA[2]  }]; #IO_L23N_T3_A02_D18_14        ,Sch=LED0
#set_property -dict { PACKAGE_PIN E19  IOSTANDARD LVCMOS33 } [get_ports { IOPortA[3]  }]; #IO_L3N_T0_DQS_EMCCLK_14      ,Sch=LED1
